...
const { login, language, odia, dashboard, subjectod, subject, contentod, content, videood, video, activity,tracing,thumbnails,tracingalphabet,number,numbNumberGameergame } = appRoute;
