...
const { login, language, odia, dashboard, subjectod, subject, contentod, thumbnails,content, videood, video, activity,tracing,thumbnails,tracingalphabet,number,numbergame } = appRoute;
