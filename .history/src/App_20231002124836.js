...
const { login, language, odia, dashboard, subjectod, subject, contentod, content, videood, video, activity,tracing,thumbnails,tracingalphabet,number,numbergame,missingnumbers } = appRoute;
    ...
    <div>
      <BrowserRouter>
        <Switch>
          ...
          <Route path={missingnumbers} component={Tracingalphabet} /> 
