...
const { login, language, odia, dashboard, subjectod, subject, contentod, thumbnailscontent, videood, video, activity,tracing,thumbnails,tracingalphabet,number,numbergame } = appRoute;
